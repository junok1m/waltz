...
const s=StyleSheet.create({item:{alignItems:"center",gap:5},compactItem:{gap:3},circle:{alignItems:"center",justifyContent:"center"},count:{position:"absolute",right:-3,top:-3,minWidth:18,height:14,borderRadius:7,paddingHorizontal:3,alignItems:"center",justifyContent:"center",backgroundColor:"#655D54",borderWidth:1,borderColor:"#F8F3E9"},countText:{fontSize:7,fontWeight:"900",color:"#FFFDF8"},label:{fontSize:9,lineHeight:11,fontWeight:"700",color:"#655D54",textAlign:"center"},compactLabel:{fontSize:7,lineHeight:8},labelTwoLines:{minHeight:22},compactLabelTwoLines:{minHeight:16}});
