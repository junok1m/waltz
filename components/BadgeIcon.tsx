...
export const BADGE_META:Record<string,BadgeMeta>={
  ...
  "mileage-10":{title:"10 km Club",color:"#E5EBDD",icon:size=><Flag size={size} strokeWidth={2} color="#687455"/>},
  "mileage-100":{title:"100 km Club",color:"#F6EBC4",icon:size=><Flag size={size} strokeWidth={2} color="#687455"/>},
  "mileage-500":{title:"500 km Club",color:"#F1DCD3",icon:size=><Flag size={size} strokeWidth={2} color="#687455"/>},
  "mileage-1000":{title:"1,000 km Club",color:"#DDE8EA",icon:size=><Flag size={size} strokeWidth={2} color="#687455"/>},
