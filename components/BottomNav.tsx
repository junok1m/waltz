...
import { ChartBar, Dog, House, PawPrint, Rss } from "@sketchyicons/react-native";

export type MainTab = "home" | "map" | "community" | "me";
...
export function BottomNav({ active, onNavigate, onStartPress }: Props) {
  return (
    <View style={styles.nav}>
      ...
      <Nav icon={<ChartBar size={22} strokeWidth={2} color={color(active === "map")} />} label="Report" active={active === "map"} onPress={() => onNavigate("map")} />
